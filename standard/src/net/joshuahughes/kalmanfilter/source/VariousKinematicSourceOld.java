...
public class VariousKinematicSourceOld extends Simple2DKinematicSourceOld 
{
	private static final long serialVersionUID = -5593617619623755656L;

	public VariousKinematicSourceOld(int timeCount, int targetCount, int observationCount, int stateCount, int obsSwapCount)
	{
