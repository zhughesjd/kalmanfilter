...
public abstract class Simple2DKinematicSourceOld extends ArrayList<Source.Data> implements Source 
{
    ...
    int stateCount;
    int obsSwapCount;
    public Simple2DKinematicSourceOld(int timeCount,int targetCount,int observationCount,int stateCount,int obsSwapCount)
    {
